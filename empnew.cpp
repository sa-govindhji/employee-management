...
int main()
{
    ...
    */
    ...
    while(1)
    {
		...
		printf("\n\t\t\t------------------------------------------------");
		printf("\n\t\t\t 1> Add Employee's Records"); /// option for add record
        printf("\n\t\t\t------------------------------------------------");
		gotoxy(30,07);
        printf("\n\t\t\t------------------------------------------------");
		printf("\n\t\t\t 2> List Employee's Records"); /// option for showing existing record
        printf("\n\t\t\t------------------------------------------------");
		gotoxy(30,9);
        printf("\n\t\t\t------------------------------------------------");
		printf("\n\t\t\t 3> Modify Employee's Records"); /// option for editing record
        printf("\n\t\t\t------------------------------------------------");
	    gotoxy(30,11);
        printf("\n\t\t\t------------------------------------------------");
	    printf("\n\t\t\t 4> Delete Employee's Records"); /// option for deleting record
        printf("\n\t\t\t------------------------------------------------");
		gotoxy(30,13);
        printf("\n\t\t\t------------------------------------------------");
	    printf("\n\t\t\t 5> Exit System"); /// exit from the program
        printf("\n\t\t\t------------------------------------------------");
		gotoxy(30,15);
        printf("\n\t\t\t------------------------------------------------");
